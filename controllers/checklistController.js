  ...
  try {
    ...
    const newChecklist = new Checklist({
      ...
      checklistOne: {
        ...
        front_glass: {
          fo_broken: req.body.fo_sealingFailbrokenure,
        ...
        solar_cells: {
          so_delamination: req.body.so_scratches,
          so_delamination_desc: req.body.so_scratches,
          so_delamination_sp: req.body.so_scratches,
          so_snailTrail: req.body.so_scratches,
          so_snailTrail_desc: req.body.so_scratches,
          so_snailTrail_sp: req.body.so_scratches,
          so_microcracks: req.body.so_scratches,
          so_microcracks_desc: req.body.so_scratches,
          so_microcracks_sp: req.body.so_scratches,
          so_darkening: req.body.so_scratches,
          so_darkening_desc: req.body.so_scratches,
          so_darkening_sp: req.body.so_scratches,
        },
      },
      checklistTwo: {
        fence: {
